            ...
            <div class="modal-body">
                <section data-name="filters">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <textarea class="form-control" spellcheck="false" id="current-value" name="current_value_txt" disabled></textarea>
                    </div>
                    <div class="input-group input-group-sm">
                        <label class="input-group-text label-min-width-120" for="new-value">Nowa wartość</label>
                        <textarea class="form-control" spellcheck="false" id="new_value-value" name="new_value"></textarea>
                    </div>
                </section>
            </div>
            <!-- end body -->
